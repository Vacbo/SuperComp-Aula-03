...
int main() {
    ...
    A.set(0, 0, 472); A.set(0, 1, 686); A.set(0, 2, 678);
    A.set(1, 0, 123); A.set(1, 1, 6); A.set(1, 2, 68);
    A.set(2, 0, 454); A.set(2, 1, 786); A.set(2, 2, 87);

    B.set(0, 0, 567); B.set(0, 1, 323); B.set(0, 2, 132);
    B.set(1, 0, 313); B.set(1, 1, 132); B.set(1, 2, 456);
    B.set(2, 0, 132); B.set(2, 1, 856); B.set(2, 2, 768);
